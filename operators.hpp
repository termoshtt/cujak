...
#define cujakDefCPlus(C)                                                       \
  __host__ __device__ inline C operator+(C c, C d) {                           \
...
#define cujakDefPlus(R, C)                                                     \
  __host__ __device__ inline C operator+(R r, C c) {                           \
    return complex(r + c.x, c.y);                                              \
  }                                                                            \
  __host__ __device__ inline C operator+(C c, R r) {                           \
    return complex(r + c.x, c.y);                                              \
  }
